...
ActiveRecord::Schema.define(version: 20150815012735) do
  ...
  create_table "posts", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "postimg_file_name"
    t.string   "postimg_content_type"
    t.integer  "postimg_file_size"
    t.datetime "postimg_updated_at"
  end
